...
const NEW_PERMISSIONS = [
  {
    key: "tiktokAnalytics.view",
    scopeType: "resource_action",
    resource: "tiktokAnalytics",
    action: "view",
    menuKey: null,
    label: "TikTok Fulfillment Analytics view",
  },
  {
    key: "menu.tiktokAnalytics",
    scopeType: "menu",
    resource: null,
    action: null,
    menuKey: "tiktokAnalytics",
    label: "menu tiktokAnalytics",
  },
];
